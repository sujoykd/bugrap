...
import com.example.bugrap.data.entity.User;
import com.example.bugrap.security.AuthenticatedUser;
import com.example.bugrap.views.bugs.BugsView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Bugs", "la la-bug", BugsView.class), //
